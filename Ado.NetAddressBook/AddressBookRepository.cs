...
namespace Ado.NetAddressBook
{
    ...
    public class AddressBookRepository
    {
        ...
        /// <summary>
        /// UC 6 : Retrieves the contacts from a given state or city.
        /// </summary>
        /// <exception cref="Exception"></exception>
        public void RetrieveContactFromACityOrState()
        {
            ...
            connection = dbc.GetConnection();
            AddressBookModel model = new AddressBookModel();
            string query = $@"select * from dbo.address_book where State='{state}' or City='{city}'";
            try
            {
                using (connection)
                {
        ...
        /// <summary>
        /// UC 7 : Gets the count of people in a state or city.
        /// </summary>
        /// <exception cref="Exception"></exception>
        public void GetCountOfContactInCityOrState()
        {
